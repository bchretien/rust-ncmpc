...
fn init_colors() {
    ...
    nc::init_pair(COLOR_PAIR_BAR_START, nc::COLOR_WHITE, color_bg);
    nc::init_pair(COLOR_PAIR_BAR_END, nc::COLOR_BLACK, color_bg);
}
...
impl View
{
    pub fn new() -> View
    {
        ...
        nc::wbkgd(view.main_win, nc::COLOR_PAIR(COLOR_PAIR_ARTIST) as nc::chtype);
    ...
    pub fn set_playlist(&mut self, desc: &[(String, u32)], data: &mut[&mut[String]])
    {
        ...
        nc::mvwprintw(self.main_win, playlist_max_row, 0, &sep);
    ...
    pub fn set_play_bar(&mut self, pct: f32)
    {
        ...
        let mut color = get_color(COLOR_PAIR_BAR_START);
        ...
        color = get_color(COLOR_PAIR_BAR_END);
        nc::wattron(self.play_bar, color);
